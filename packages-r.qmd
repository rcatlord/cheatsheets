...
## Setup
1. Create package template: `usethis::create_package("~rproj/pkgname")`
2. Edit DESCRIPTION
3. Add a LICENSE: `usethis::use_ccby_licence()`
4. Add Authors
5. Create and update README.md: `usethis::use_readme_rmd()`
6. Load package: `devtools::load()`

## Add data
1. Create folder for raw data and .R file: `usethis::use_data_raw("dataset")`
2. Edit dataset.R
...
4. Add documentation: `usethis::use_r("dataset")`
5. Update package documentation: `devtools::document()`
6. Load in package: `devtools::load_all(".")`
7. Access data: `data("dataset", package = "pkgname")`
8. View documentation: `?pkgname::dataset`
...
2. Add package dependency to NAMESPACE: `r usethis::use_dev_package("gt")`